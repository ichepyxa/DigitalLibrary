    ...
    <section class='bg-white w-full py-16'>
      <div class="max-w-lg p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        <form action="" method='post'>
          <h2 class="text-3xl text-center font-semibold text-white mb-5">Создание книги</h2>
          <div>
            ...
            <input id="name" name="name" type="text"
              ...
              placeholder="Имя книги" required>
          </div>
          <div class="mt-4">
            ...
            <div class="flex justify-between items-stretch flex-wrap gap-4 mt-2">
              <select id="author_id"
                ...
                foreach ($authors as $key => $author) {
                  $attr = (isset($_GET['author_id']) && $author['author_id'] == $_GET['author_id']) ? 'selected' : '';
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              <div>
                ...
                <input id="publish_name" name="publish_name" type="text"
                  class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                  placeholder="Место публикации" required>
              </div>
              <div>
                ...
                <input id="publish_city" name="publish_city" type="text"
                  class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                  placeholder="Город публикации" required>
              </div>
            </div>
          </div>
          ...
          if (
            ...
            $result = $libraryService->createBook(
              $_POST['name'],
              $_POST['publish_year'],
              $_POST['description'],
              $_POST['count'],
